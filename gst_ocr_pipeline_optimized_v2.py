...
def process_invoice_to_registry(file_source, filename_hint: str = None,
                                 ...
                                 save_to_db: bool = True, db_path=DB_PATH) -> dict:
    """
...
def process_invoices_folder(input_dir: str = "invoices", output_dir: str = "processed_invoices",
                             ...
                             type_of_inward_supply: str = None) -> dict:
    """
    ...
    results = {"processed": [], "failed": [], "needs_review": [], "output_dir": str(output_path)}
    ...
    print(f"\nDone: {len(results['processed'])} processed, {len(results['failed'])} failed, "
          f"{len(results['needs_review'])} flagged for review.")
